  ...
  return (
    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in duration-500 pt-24 pb-12">
      <div className="flex items-center gap-4 mb-6 lg:mb-8">
        ...
        <div>
          <h2 className="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight uppercase leading-none">Buscador Inteligente</h2>
        ...
        <div className="bg-white rounded-[2.5rem] shadow-xl border border-slate-100 overflow-hidden flex flex-col md:flex-row mt-8">
           <div className="w-full md:w-1/3 bg-slate-50 relative min-h-[250px] lg:min-h-[300px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 lg:p-8">
                 ...
                 <p className="text-white text-lg lg:text-xl font-black uppercase">{selectedPart.locationInCar}</p>
              </div>
           </div>
           ...
           <div className="flex-1 p-6 lg:p-10 space-y-6 lg:space-y-8">
              <div className="flex justify-between items-start">
                 <div>
                    ...
                    <h1 className="text-2xl lg:text-4xl font-black text-slate-900 uppercase mt-2 mb-1">{selectedPart.name}</h1>
                 ...
                 <div className="text-right">
                    <p className="text-2xl lg:text-3xl font-black text-slate-900">${selectedPart.price.toLocaleString()}</p>
              ...
              <div className="grid grid-cols-2 gap-6 lg:gap-8">
                 <div className="bg-slate-50 p-4 lg:p-6 rounded-2xl border border-slate-100">
                    ...
                    <p className="text-3xl lg:text-4xl font-black text-slate-900">{totalStock}</p>
                 </div>
                 <div className="bg-slate-50 p-4 lg:p-6 rounded-2xl border border-slate-100">
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                       <ShoppingCart size={12} /> Estado
                    </p>
                    <p className={`text-lg lg:text-xl font-black uppercase ${totalStock > 0 ? 'text-emerald-600' : 'text-red-600'}`}>
                       {totalStock > 0 ? 'Disponible' : 'Sin Stock'}
                    </p>
                 </div>
              </div>

              <div className="bg-slate-900 text-white p-4 lg:p-6 rounded-2xl">
