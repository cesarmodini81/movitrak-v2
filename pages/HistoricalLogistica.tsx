...
export const HistoricalLogistica: React.FC = () => {
  ...
  const handleBulkRestore = () => {
    ...
    toast.innerHTML = `<div class="bg-white text-emerald-600 p-1.5 rounded-full"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg></div><div><p class="font-bold text-xs uppercase tracking-widest">Unidades restauradas a Planilla Logística</p></div>`;
    ...
    <div className="space-y-6 animate-in fade-in duration-500 min-h-screen pt-20 md:pt-24">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <div className="flex items-center gap-4 w-full md:w-auto">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 tracking-tight uppercase">Histórica de Logística</h2>
